...
public class CarDto {
	...
	private int speed;
	public CarDto() {
		System.out.println("created default constructed of car");
	}
	...
	public String toString() {
		return "CarDto [brand=" + brand + ", price=" + price + ", colour=" + colour + ", type=" + type + ", speed="
				+ speed + ", getBrand()=" + getBrand() + ", getPrice()=" + getPrice() + ", getColour()=" + getColour()
				+ ", getType()=" + getType() + ", getSpeed()=" + getSpeed() + ", getClass()=" + getClass()
